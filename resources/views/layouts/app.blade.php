...
@endphp
<!doctype html>
<html lang="{{ $currentLocale }}" dir="{{ $direction }}" data-theme="light">
<head>
    <meta charset="utf-8">
    ...
    <script>document.documentElement.dataset.theme=localStorage.getItem('ajlan-theme')||'light';</script>
...
<body>
    ...
    <nav class="quick-contact" aria-label="{{ __('site.contact') }}">
        ...
        <a href="https://wa.me/{{ preg_replace('/\D/', '', config('app.contact_phone')) }}" aria-label="واتساب">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
