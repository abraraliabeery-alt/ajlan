        ...
        foreach ($plots as $index => [$code, $units, $land, $built, $min, $max, $side, $middle, $featured]) {
            ...
            $translations = [
                'ar' => [
                    ...
                    'description' => "توفّر القطعة {$code} ضمن مخطط عجلان وإخوانه في جنوب الرياض {$units} وحدة صناعية مناسبة للتخزين والخدمات اللوجستية، بارتفاعات تشغيلية تبدأ من {$number($side)} م وتصل إلى {$number($middle)} م.",
